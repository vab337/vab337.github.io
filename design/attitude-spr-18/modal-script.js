...
let photo13 = document.getElementById('photo13')
let photo14 = document.getElementById('photo14')
...
photo11.onclick = () => {
  modal.style.display = "block";
  modalImg.src = photo11.src;
  photoNum = 11
}

photo12.onclick = () => {
  modal.style.display = "block";
  modalImg.src = photo12.src;
  photoNum = 12
}

photo13.onclick = () => {
  modal.style.display = "block";
  modalImg.src = photo13.src;
  photoNum = 13
}

photo14.onclick = () => {
  modal.style.display = "block";
  modalImg.src = photo14.src;
  photoNum = 14
}
