...
function setup() {
  ...
  btn1.position(btnStartPos, windowHeight-70);
  btn1.mousePressed(state1);

  btn2= createButton('Excited');
  btn2.position(btnStartPos+150, windowHeight-70);
  btn2.mousePressed(state2);


  btn3= createButton('Good');
  btn3.position(btnStartPos+300, windowHeight-70);
  btn3.mousePressed(state3);

  btn4 = createButton('Meh');
  btn4.position(btnStartPos+450, windowHeight-70);
  btn4.mousePressed(state4);

  btn5 = createButton('Stressed');
  btn5.position(btnStartPos+600, windowHeight-70);
